...
(function () {
  const UI = {
    zh: {
      ...
      dataJsonFound: '检测到 data.json，可点击“读取 data.json”同步',
    ...
    en: {
      ...
      dataJsonFound: 'data.json detected. Click “Load data.json” to sync',
    ...
    tr: {
      ...
      dataJsonFound: 'data.json bulundu. Senkronize etmek için “data.json oku”ya tıklayın',
