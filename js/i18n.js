...
(function () {
  const UI = {
    zh: {
      ...
      githubSyncHint: 'Token 会保存到 data.json，其他设备会自动读取',
      githubOwner: 'Owner',
      githubRepo: 'Repository',
      githubBranch: 'Branch',
      githubToken: 'GitHub Token',
      saveGithubSettings: '保存同步设置',
      githubTokenSecurity: '点击保存后，Token 会直接写入 data.json；其他设备打开网站后会自动读取。',
      githubSettingsSaved: '同步设置已保存。',
      githubSettingsSavedToDataJson: '同步设置和 Token 已保存到 data.json。',
    ...
    en: {
      ...
      githubSyncHint: 'The token is saved in data.json and loaded by other devices automatically',
      githubOwner: 'Owner',
      githubRepo: 'Repository',
      githubBranch: 'Branch',
      githubToken: 'GitHub Token',
      saveGithubSettings: 'Save sync settings',
      githubTokenSecurity: 'After saving, the token is written into data.json. Other devices will load it automatically.',
      githubSettingsSaved: 'Sync settings saved.',
      githubSettingsSavedToDataJson: 'Sync settings and token saved to data.json.',
    ...
    tr: {
      ...
      githubSyncHint: 'Token data.json içine kaydedilir ve diğer cihazlar otomatik okur',
      githubOwner: 'Owner',
      githubRepo: 'Repository',
      githubBranch: 'Branch',
      githubToken: 'GitHub Token',
      saveGithubSettings: 'Senkron ayarlarını kaydet',
      githubTokenSecurity: 'Kaydettikten sonra token data.json içine yazılır. Diğer cihazlar otomatik okur.',
      githubSettingsSaved: 'Senkron ayarları kaydedildi.',
      githubSettingsSavedToDataJson: 'Senkron ayarları ve token data.json dosyasına kaydedildi.',
